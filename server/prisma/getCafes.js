...
exports.default = getCafesFromOverPass;
async function getCafesFromOverPass() {
    const query = `
...
`;
    ...
    if (typeof data === "object" && data !== null && "elements" in data) {
        ...
        console.log("SOMETHING WENT WRONG WITH GRABBING THE CAFES... WHAT THE HECK!!!!!");
    }
}
getCafesFromOverPass();
//# sourceMappingURL=getCafes.js.map